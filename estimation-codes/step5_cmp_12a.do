//==============================================================================
//	STEP 5a : CMP IVPROBIT REGRESSIONS (2012) 
//==============================================================================
//  Instructions:
//------------------------------------------------------------------------------
...
// open logfile ... 
//------------------------------------------------------------------------------
log using "C:\ihds\step5_cmp_12a", replace
...
foreach m of local depvars { 
	...
	pe cap nois cmp ( `m' = `elecvar' `cvars' `ovars' ) ( `elecvar' = `cvars' `ovars' `inst'), ind($cmp_probit $cmp_cont) qui robust 
...
esttab using step5_cmp_12a.tex , b(a6) se(6) wide starlevels("\sym{*}" 0.100 "\sym{**}" 0.050 "\sym{***}" 0.010) replace 
