//==============================================================================
//	STEP 6 : RECURSIVE BIVARIATE PROBIT REGRESSIONS (2012); SEX = FEMALE
//==============================================================================
//  Instructions:
//------------------------------------------------------------------------------
...
// open logfile ... 
//------------------------------------------------------------------------------
log using "C:\ihds\step6_rbiprobitg_12", replace
...
foreach m of local depvars { 
	...
	pe keep if inlist( sample, 1 ) // reg sample 
        ...
        pe cap nois rbiprobit `m' = `cvars' `ovars' ,  iterate(100) endog(`elecvar' = `cvars' `ovars' `inst') vce( robust )
...
esttab using step6_rbiprobitg_12.tex , b(a6) se(6) wide starlevels("\sym{*}" 0.100 "\sym{**}" 0.050 "\sym{***}" 0.010) replace 
