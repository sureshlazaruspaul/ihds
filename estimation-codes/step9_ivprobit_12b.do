//==============================================================================
//	STEP 9 : IVPROBIT REGRESSIONS (2012) - WEIGHTED
//==============================================================================
//  Instructions:
//------------------------------------------------------------------------------
...
// open logfile ... 
//------------------------------------------------------------------------------
log using "C:\ihds\step9_ivprobit_12b", replace
...
foreach m of local depvars { 
	...
	* adolescents rural ed4x
	...
	pe svyset psuid [pw = weight] , singleunit(scaled) strata(newstrat) 
        ...
        pe svy, subpop(sample) : probit `m' `elecvar' `cvars' `ovars' v2hat 
...
esttab using step9_ivprobit_12b.tex , b(a6) se(6) wide starlevels("\sym{*}" 0.100 "\sym{**}" 0.050 "\sym{***}" 0.010) replace 
