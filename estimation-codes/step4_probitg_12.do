//==============================================================================
//	STEP 4 : PROBIT REGRESSIONS (2012); SEX = FEMALE
//==============================================================================
//  Instructions:
//------------------------------------------------------------------------------
...
log using "C:\ihds\step4_probitg_12", replace
...
foreach m of local depvars { 
	...
	pe use "$indat" , clear 
        ...
        pe probit `m' i.fu1 `cvars' `ovars'  , vce( robust ) 
...
esttab using step4_probitg_12.tex , b(a6) se(6) wide starlevels("\sym{*}" 0.100 "\sym{**}" 0.050 "\sym{***}" 0.010) replace 
