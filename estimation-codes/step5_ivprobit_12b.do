//==============================================================================
//	STEP 5 : IVPROBIT REGRESSIONS (2012) 
//==============================================================================
//  Instructions:
//------------------------------------------------------------------------------
...
// open logfile ... 
//------------------------------------------------------------------------------
log using "C:\ihds\step5_ivprobit_12b", replace
...
foreach m of local depvars { 
	...
	pe probit `m' `elecvar' `cvars' `ovars' v2hat
...
esttab using step5_ivprobit_12b.tex , b(a6) se(6) wide starlevels("\sym{*}" 0.100 "\sym{**}" 0.050 "\sym{***}" 0.010) replace 
