//==============================================================================
//	STEP 7 : SPECIAL REGRESSIONS (2012); SEX = MALE
//==============================================================================
//  Instructions:
//------------------------------------------------------------------------------
...
// open logfile ... 
//------------------------------------------------------------------------------
log using "C:\ihds\step7_spregb_12", replace
...
local cvars1 age          copc1 nchildren hheduc   hhfemale hhage      mdm   privsch 
...
esttab using step7_spregb_12.tex , b(a6) se(6) wide starlevels("\sym{*}" 0.100 "\sym{**}" 0.050 "\sym{***}" 0.010) replace 
