//==============================================================================
//	STEP 9: CMP IVPROBIT REGRESSIONS -WEIGHTED (2012) 
//==============================================================================
//  Instructions:
//------------------------------------------------------------------------------
...
// open logfile ... 
//------------------------------------------------------------------------------
log using "C:\ihds\step9_cmp_12a", replace
...
foreach m of local depvars { 
	...
	* adolescents rural ed4x
	...
	pe svy, subpop(sample) : cmp ( `m' = `elecvar' `cvars' `ovars' ) ( `elecvar' = `cvars' `ovars' `inst'), ind($cmp_probit $cmp_cont) qui 
...
esttab using step9_cmp_12a.tex , b(a6) se(6) wide starlevels("\sym{*}" 0.100 "\sym{**}" 0.050 "\sym{***}" 0.010) replace 
