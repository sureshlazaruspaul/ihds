//==============================================================================
//	STEP 10: CMP BIVARIATE PROBIT REGRESSIONS -WEIGHTED (2012); SEX = MALE
//==============================================================================
//  Instructions:
//------------------------------------------------------------------------------
...
// open logfile ... 
//------------------------------------------------------------------------------
log using "C:\ihds\step10_cmpb_12", replace
...
esttab using step10_cmpb_12.tex , b(a6) se(6) wide starlevels("\sym{*}" 0.100 "\sym{**}" 0.050 "\sym{***}" 0.010) replace 
