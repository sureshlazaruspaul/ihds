//==============================================================================
//	STEP 5 : IVREG2 REGRESSIONS (2012); SEX = FEMALE 
//==============================================================================
//  Instructions:
//------------------------------------------------------------------------------
...
log using "C:\ihds\step5_ivreg2g_12", replace
...
foreach m of local depvars { 
	...
	pe use "$indat" , clear 
		...
		di _n "-----------------------------------------------------------------" 
		di    "{title:IV REGRESSIONS}"
		di    "-----------------------------------------------------------------" 
		di    "Education variable: `m'" 
		di    "-----------------------------------------------------------------"

		pe ivreg2 `m' `cvars' `ovars' (fu1 = `inst') , first endog( fu1 ) robust

		pe eststo: margins , dydx(fu1) post	// marginal effects
...
esttab using step5_ivreg2g_12.tex , b(a6) se(6) wide starlevels("\sym{*}" 0.100 "\sym{**}" 0.050 "\sym{***}" 0.010) replace 
