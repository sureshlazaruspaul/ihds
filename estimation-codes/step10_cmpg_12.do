//==============================================================================
//	STEP 10: CMP BIVARIATE PROBIT REGRESSIONS -WEIGHTED (2012); SEX = FEMALE
//==============================================================================
//  Instructions:
//------------------------------------------------------------------------------
...
// open logfile ... 
//------------------------------------------------------------------------------
log using "C:\ihds\step10_cmpg_12", replace
...
foreach m of local depvars { 
	...
	* adolescents rural ed4x
	...
	pe svy, subpop(sample) : cmp ( `m' = `elecvar' `cvars' `ovars' ) ( `elecvar' = `cvars' `ovars' `inst') , ind($cmp_probit $cmp_probit) qui 
...
esttab using step10_cmpg_12.tex , b(a6) se(6) wide starlevels("\sym{*}" 0.100 "\sym{**}" 0.050 "\sym{***}" 0.010) replace 
