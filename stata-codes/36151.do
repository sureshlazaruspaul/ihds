...
local yesnovars adivasi brahmin csj dalit elecfree elecoth elecpay elecqual1 elecqual2 female forward fu1 fu12005 govtsch_middaymeal hhfemale hhhead married muslim othback privsch_middaymeal teacher_absence wkany1 
...
label variable govtsch_middaymeal "Government School w/ Midday Meal Program (Yes/No)" 
...
label variable privsch_middaymeal "Private School w/ Midday Meal Program (Yes/No)" 
label variable propgovtmeal       "Proportion of Govt. School in Village with Midday Meals" 
label variable propprivmeal       "Proportion of Priv. School in Village with Midday Meals" 
...
format propgovtmeal propprivmeal %9.6f
