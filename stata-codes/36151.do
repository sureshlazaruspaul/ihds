...
g elecqual4 = inlist(fu1, 1) & (fu1a <= hourselec) 
	replace elecqual4 = 2 if inlist(fu1, 1) & (fu1a > hourselec) 
...
label variable elecqual4           "Electricity: quality (using fu1, fu1a > hourselec)"
